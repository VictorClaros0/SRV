...
// MesaHandler agrupa los handlers HTTP para Mesa.
type MesaHandler struct {
	repo *repository.MesaRepository
}

// NewMesaHandler crea un nuevo handler.
func NewMesaHandler(repo *repository.MesaRepository) *MesaHandler {
	return &MesaHandler{repo: repo}
}

// GetAll godoc — GET /api/v1/mesas
...
// GetByID godoc — GET /api/v1/mesas/:id
...
// Create godoc — POST /api/v1/mesas
func (h *MesaHandler) Create(c *gin.Context) {
	var body models.Mesa
...
// Update godoc — PUT /api/v1/mesas/:id
...
// Delete godoc — DELETE /api/v1/mesas/:id
