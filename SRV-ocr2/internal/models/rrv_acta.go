...
type RRVActa struct {
	...
	// Campos de SMS inbound
	Remitente     string `bson:"remitente,omitempty"     json:"remitente,omitempty"`
	SMSBody       string `bson:"sms_body,omitempty"      json:"sms_body,omitempty"`
	Duplicado     bool   `bson:"duplicado,omitempty"     json:"duplicado,omitempty"`
